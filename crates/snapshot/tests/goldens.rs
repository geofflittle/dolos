...
const GOLDEN_INSCRIPTION: &str =
    "sha256:58bb69fb4935109835e9221c2afa7418af7c6e3456e085fd21c7f896540bffe9";
...
const CANONICAL_INSCRIPTION: &str = concat!(
    ...
    r#""schemas":{"account-epochs":1,"account-stakes":0,"accounts":1,"assets":1,"datums":1,"dreps":1,"epochs":3,"eras":1,"gov":1,"leader-rewards":0,"member-rewards":0,"pending_mirs":1,"pending_rewards":1,"pool-deposit-refunds":0,"pools":1,"proposals":1,"stakes":1,"utxos":1},"#,
